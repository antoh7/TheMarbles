...
import static ru.kbuearpov.themarbles.constants.Constants.CHARACTERS;
import static ru.kbuearpov.themarbles.constants.Constants.EVEN;
import static ru.kbuearpov.themarbles.constants.Constants.GAME_FINISHED;
import static ru.kbuearpov.themarbles.constants.Constants.GAME_RUNNING;
import static ru.kbuearpov.themarbles.constants.Constants.HEIGHT;
import static ru.kbuearpov.themarbles.constants.Constants.ODD;
import static ru.kbuearpov.themarbles.constants.Constants.RANDOMIZING_TURN;
import static ru.kbuearpov.themarbles.constants.Constants.SERVER;
import static ru.kbuearpov.themarbles.constants.Constants.WAITING_FOR_PLAYER_CONNECT;
import static ru.kbuearpov.themarbles.constants.Constants.WAITING_FOR_START;
...
import ru.kbuearpov.themarbles.Player;
import ru.kbuearpov.themarbles.myImpls.SelectBox;
import ru.kbuearpov.themarbles.myImpls.SerializableImage;
import ru.kbuearpov.themarbles.networking.DataPacket;
import ru.kbuearpov.themarbles.networking.Receiver;
import ru.kbuearpov.themarbles.utils.FontGenerator;
import ru.kbuearpov.themarbles.utils.GameUtils;
import ru.kbuearpov.themarbles.utils.ThreadFactory;
...
public class Room implements Screen {
    ...
    private void initNetUpdateListener(){
        ...
        while (!gameState.equals(GAME_FINISHED)) {
            ...
            Thread eventUpdateManager = threadFactory.getThread("event_update_manager_thread");
            synchronized (eventUpdateManager) {
                eventUpdateManager.notify();
            }
    ...
    private void initBetSelectionWindow(){
        ...
        betSelection.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                ...
                if (!betSelection.canBeExecuted()) return;
                ...
                if (ourTurn) {
                    ...
                    receiver.sendData(new DataPacket(gameState, ourTurn, weReady, we));
